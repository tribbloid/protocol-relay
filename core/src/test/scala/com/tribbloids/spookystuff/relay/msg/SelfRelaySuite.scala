...
//
//class SelfRelaySuite extends FunSpecx {
//
...
//      2 * k
//    }
//    val reader = new SelfRelay[Int => Int]()
...
//
//    val xmlStr = IRWriter(obj).toXMLStr(pretty = false)
//    xmlStr.shouldBeLike(
//      s"<TimeWrapper><time>......</time></TimeWrapper>"
//    )
//
//    val reader = new SelfRelay[TimeWrapper]().read
...
//
//    val reader = new SelfRelay[TimeWrapper]()
//    val v = reader.fromXML(xmlStr)
...
//       """.stripMargin
//
//    val reader = new SelfRelay[Users]()
//    intercept[MappingException] {
//      reader.fromXML(xmlStr)
//    }
//  }
...
//       """.stripMargin
//
//    val reader = new SelfRelay[UsersWrapper]()
//    intercept[MappingException] {
//      reader.fromXML(xmlStr)
//    }
//  }
...
//
//    val xmlStr = IRWriter(User(name = "30")).toXMLStr(pretty = false)
//    xmlStr.shouldBe(
...
//    val jsonStr = IRWriter(ex).toJSON()
//    jsonStr.shouldBe(
//      s"""
//         |{
//         |  "a" : "aa",
...
//    )
//
//    val reader = implicitly[SelfRelay[Multipart]]
//
//    intercept[MappingException] {
