...
import com.tribbloids.spookystuff.relay.utils.CachingUtils
import org.json4s._
...
//  object ExceptionMetadata extends Relay.Implicits
  ...
  val cached: CachingUtils.ConcurrentCache[Long, ParsingException] =
    CachingUtils.ConcurrentCache[Long, ParsingException]()

  trait ExceptionLike extends Throwable {
  ...
  class ParsingException(
    ...
    override def detail: String = { // TODO: why is it necessary? already in the default scope

      import org.json4s.jackson.JsonMethods._

      val jv = Extraction.decompose(metadata)(XMLFormats.defaultFormats)
      val json = compact(render(jv))
